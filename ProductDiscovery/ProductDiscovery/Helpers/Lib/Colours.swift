...
public extension Color {
    ...
    convenience init(CIE_LAB: (l: CGFloat, a: CGFloat, b: CGFloat, alpha: CGFloat)) {
        ...
        let deltaRGB: TransformBlock = { k in
            if(k > 0.0031308){
                return 1.055 * (pow(k, (1/2.4))) - 0.055
            } else {
                return k * 12.92
            }
        }
    ...
    func hsba() -> (h: CGFloat, s: CGFloat, b: CGFloat, a: CGFloat) {
        ...
        if self.responds(to: NSSelectorFromString("getHue:saturation:brightness:alpha:")) && self.cgColor.numberOfComponents == 4 {
    ...
    func CIE_LAB() -> (l: CGFloat, a: CGFloat, b: CGFloat, alpha: CGFloat) {
        ...
        let deltaF: TransformBlock = { f in
            let transformation:CGFloat?
                ...
                {
                    let v:CGFloat = pow((29.0/6.0), 2.0) * (1/3)
                    transformation = v * f + 4/29.0
                }
    ...
    func complementaryColor() -> Color {
        let hsbaT = hsba()
        let newH = Color.addDegree(addDegree: 180.0, staticDegree: hsbaT.h*360.0)
    ...
    {
        return self.colorWith(R: 83, G:215, B:106, A:1.0)
    }
    
    class func warningColor() -> Color
    {
        return self.colorWith(R: 221, G:170, B:59, A:1.0)
    }
    
    class func dangerColor() -> Color
    {
        return self.colorWith(R: 229, G:0, B:15, A:1.0)
    }
    ...
    {
        return self.colorWith(R: 250, G:235, B:215, A:1.0)
    }
    
    class func oldLaceColor() -> Color
    {
        return self.colorWith(R: 253, G:245, B:230, A:1.0)
    }
    
    class func ivoryColor() -> Color
    {
        return self.colorWith(R: 255, G:255, B:240, A:1.0)
    }
    
    class func seashellColor() -> Color
    {
        return self.colorWith(R: 255, G:245, B:238, A:1.0)
    }
    
    class func ghostWhiteColor() -> Color
    {
        return self.colorWith(R: 248, G:248, B:255, A:1.0)
    }
    
    class func snowColor() -> Color
    {
        return self.colorWith(R: 255, G:250, B:250, A:1.0)
    }
    
    class func linenColor() -> Color
    {
        return self.colorWith(R: 250, G:240, B:230, A:1.0)
    }
    ...
    {
        return self.colorWith(R: 133, G:117, B:112, A:1.0)
    }
    
    class func coolGrayColor() -> Color
    {
        return self.colorWith(R: 118, G:122, B:133, A:1.0)
    }
    
    class func charcoalColor() -> Color
    {
        return self.colorWith(R: 34, G:34, B:34, A:1.0)
    }
    ...
    {
        return self.colorWith(R: 28, G:160, B:170, A:1.0)
    }
    
    class func steelBlueColor() -> Color
    {
        return self.colorWith(R: 103, G:153, B:170, A:1.0)
    }
    
    class func robinEggColor() -> Color
    {
        return self.colorWith(R: 141, G:218, B:247, A:1.0)
    }
    
    class func pastelBlueColor() -> Color
    {
        return self.colorWith(R: 99, G:161, B:247, A:1.0)
    }
    
    class func turquoiseColor() -> Color
    {
        return self.colorWith(R: 112, G:219, B:219, A:1.0)
    }
    
    class func skyBlueColor() -> Color
    {
        return self.colorWith(R: 0, G:178, B:238, A:1.0)
    }
    
    class func indigoColor() -> Color
    {
        return self.colorWith(R: 13, G:79, B:139, A:1.0)
    }
    
    class func denimColor() -> Color
    {
        return self.colorWith(R: 67, G:114, B:170, A:1.0)
    }
    
    class func blueberryColor() -> Color
    {
        return self.colorWith(R: 89, G:113, B:173, A:1.0)
    }
    
    class func cornflowerColor() -> Color
    {
        return self.colorWith(R: 100, G:149, B:237, A:1.0)
    }
    
    class func babyBlueColor() -> Color
    {
        return self.colorWith(R: 190, G:220, B:230, A:1.0)
    }
    
    class func midnightBlueColor() -> Color
    {
        return self.colorWith(R: 13, G:26, B:35, A:1.0)
    }
    
    class func fadedBlueColor() -> Color
    {
        return self.colorWith(R: 23, G:137, B:155, A:1.0)
    }
    
    class func icebergColor() -> Color
    {
        return self.colorWith(R: 200, G:213, B:219, A:1.0)
    }
    
    class func waveColor() -> Color
    {
        return self.colorWith(R: 102, G:169, B:251, A:1.0)
    }
    ...
    {
        return self.colorWith(R: 1, G:152, B:117, A:1.0)
    }
    
    class func grassColor() -> Color
    {
        return self.colorWith(R: 99, G:214, B:74, A:1.0)
    }
    
    class func pastelGreenColor() -> Color
    {
        return self.colorWith(R: 126, G:242, B:124, A:1.0)
    }
    
    class func seafoamColor() -> Color
    {
        return self.colorWith(R: 77, G:226, B:140, A:1.0)
    }
    
    class func paleGreenColor() -> Color
    {
        return self.colorWith(R: 176, G:226, B:172, A:1.0)
    }
    
    class func cactusGreenColor() -> Color
    {
        return self.colorWith(R: 99, G:111, B:87, A:1.0)
    }
    
    class func chartreuseColor() -> Color
    {
        return self.colorWith(R: 69, G:139, B:0, A:1.0)
    }
    
    class func hollyGreenColor() -> Color
    {
        return self.colorWith(R: 32, G:87, B:14, A:1.0)
    }
    
    class func oliveColor() -> Color
    {
        return self.colorWith(R: 91, G:114, B:34, A:1.0)
    }
    
    class func oliveDrabColor() -> Color
    {
        return self.colorWith(R: 107, G:142, B:35, A:1.0)
    }
    
    class func moneyGreenColor() -> Color
    {
        return self.colorWith(R: 134, G:198, B:124, A:1.0)
    }
    
    class func honeydewColor() -> Color
    {
        return self.colorWith(R: 216, G:255, B:231, A:1.0)
    }
    
    class func limeColor() -> Color
    {
        return self.colorWith(R: 56, G:237, B:56, A:1.0)
    }
    
    class func cardTableColor() -> Color
    {
        return self.colorWith(R: 87, G:121, B:107, A:1.0)
    }
    ...
    {
        return self.colorWith(R: 233, G:87, B:95, A:1.0)
    }
    
    class func brickRedColor() -> Color
    {
        return self.colorWith(R: 151, G:27, B:16, A:1.0)
    }
    
    class func easterPinkColor() -> Color
    {
        return self.colorWith(R: 241, G:167, B:162, A:1.0)
    }
    
    class func grapefruitColor() -> Color
    {
        return self.colorWith(R: 228, G:31, B:54, A:1.0)
    }
    
    class func pinkColor() -> Color
    {
        return self.colorWith(R: 255, G:95, B:154, A:1.0)
    }
    
    class func indianRedColor() -> Color
    {
        return self.colorWith(R: 205, G:92, B:92, A:1.0)
    }
    
    class func strawberryColor() -> Color
    {
        return self.colorWith(R: 190, G:38, B:37, A:1.0)
    }
    
    class func coralColor() -> Color
    {
        return self.colorWith(R: 240, G:128, B:128, A:1.0)
    }
    
    class func maroonColor() -> Color
    {
        return self.colorWith(R: 80, G:4, B:28, A:1.0)
    }
    
    class func watermelonColor() -> Color
    {
        return self.colorWith(R: 242, G:71, B:63, A:1.0)
    }
    
    class func tomatoColor() -> Color
    {
        return self.colorWith(R: 255, G:99, B:71, A:1.0)
    }
    
    class func pinkLipstickColor() -> Color
    {
        return self.colorWith(R: 255, G:105, B:180, A:1.0)
    }
    
    class func paleRoseColor() -> Color
    {
        return self.colorWith(R: 255, G:228, B:225, A:1.0)
    }
    
    class func crimsonColor() -> Color
    {
        return self.colorWith(R: 187, G:18, B:36, A:1.0)
    }
    ...
    {
        return self.colorWith(R: 105, G:5, B:98, A:1.0)
    }
    
    class func pastelPurpleColor() -> Color
    {
        return self.colorWith(R: 207, G:100, B:235, A:1.0)
    }
    
    class func palePurpleColor() -> Color
    {
        return self.colorWith(R: 229, G:180, B:235, A:1.0)
    }
    
    class func coolPurpleColor() -> Color
    {
        return self.colorWith(R: 140, G:93, B:228, A:1.0)
    }
    
    class func violetColor() -> Color
    {
        return self.colorWith(R: 191, G:95, B:255, A:1.0)
    }
    
    class func plumColor() -> Color
    {
        return self.colorWith(R: 139, G:102, B:139, A:1.0)
    }
    
    class func lavenderColor() -> Color
    {
        return self.colorWith(R: 204, G:153, B:204, A:1.0)
    }
    
    class func raspberryColor() -> Color
    {
        return self.colorWith(R: 135, G:38, B:87, A:1.0)
    }
    
    class func fuschiaColor() -> Color
    {
        return self.colorWith(R: 255, G:20, B:147, A:1.0)
    }
    
    class func grapeColor() -> Color
    {
        return self.colorWith(R: 54, G:11, B:88, A:1.0)
    }
    
    class func periwinkleColor() -> Color
    {
        return self.colorWith(R: 135, G:159, B:237, A:1.0)
    }
    
    class func orchidColor() -> Color
    {
        return self.colorWith(R: 218, G:112, B:214, A:1.0)
    }
    ...
    {
        return self.colorWith(R: 215, G:170, B:51, A:1.0)
    }
    
    class func yellowGreenColor() -> Color
    {
        return self.colorWith(R: 192, G:242, B:39, A:1.0)
    }
    
    class func bananaColor() -> Color
    {
        return self.colorWith(R: 229, G:227, B:58, A:1.0)
    }
    
    class func mustardColor() -> Color
    {
        return self.colorWith(R: 205, G:171, B:45, A:1.0)
    }
    
    class func buttermilkColor() -> Color
    {
        return self.colorWith(R: 254, G:241, B:181, A:1.0)
    }
    
    class func goldColor() -> Color
    {
        return self.colorWith(R: 139, G:117, B:18, A:1.0)
    }
    
    class func creamColor() -> Color
    {
        return self.colorWith(R: 240, G:226, B:187, A:1.0)
    }
    
    class func lightCreamColor() -> Color
    {
        return self.colorWith(R: 240, G:238, B:215, A:1.0)
    }
    ...
    {
        return self.colorWith(R: 245, G:245, B:220, A:1.0)
    }
    ...
    {
        return self.colorWith(R: 242, G:187, B:97, A:1.0)
    }
    
    class func burntOrangeColor() -> Color
    {
        return self.colorWith(R: 184, G:102, B:37, A:1.0)
    }
    
    class func pastelOrangeColor() -> Color
    {
        return self.colorWith(R: 248, G:197, B:143, A:1.0)
    }
    
    class func cantaloupeColor() -> Color
    {
        return self.colorWith(R: 250, G:154, B:79, A:1.0)
    }
    
    class func carrotColor() -> Color
    {
        return self.colorWith(R: 237, G:145, B:33, A:1.0)
    }
    
    class func mandarinColor() -> Color
    {
        return self.colorWith(R: 247, G:145, B:55, A:1.0)
    }
    ...
    {
        return self.colorWith(R: 199, G:63, B:23, A:1.0)
    }
    
    class func burntSiennaColor() -> Color
    {
        return self.colorWith(R: 138, G:54, B:15, A:1.0)
    }
    
    class func chocolateColor() -> Color
    {
        return self.colorWith(R: 94, G:38, B:5, A:1.0)
    }
    
    class func coffeeColor() -> Color
    {
        return self.colorWith(R: 141, G:60, B:15, A:1.0)
    }
    
    class func cinnamonColor() -> Color
    {
        return self.colorWith(R: 123, G:63, B:9, A:1.0)
    }
    
    class func almondColor() -> Color
    {
        return self.colorWith(R: 196, G:142, B:72, A:1.0)
    }
    
    class func eggshellColor() -> Color
    {
        return self.colorWith(R: 252, G:230, B:201, A:1.0)
    }
    
    class func sandColor() -> Color
    {
        return self.colorWith(R: 222, G:182, B:151, A:1.0)
    }
    
    class func mudColor() -> Color
    {
        return self.colorWith(R: 70, G:45, B:29, A:1.0)
    }
    
    class func siennaColor() -> Color
    {
        return self.colorWith(R: 160, G:82, B:45, A:1.0)
    }
    
    class func dustColor() -> Color
    {
        return self.colorWith(R: 236, G:214, B:197, A:1.0)
    }
